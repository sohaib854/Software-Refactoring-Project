<#
    Script: run_refminer_jant_1_10_14_after.ps1
    Purpose: Runs RefactoringMiner on JAnt repo for commits
             after version 1.10.14 — window between 24 July 2023 and 20 Aug 2023 (28 days).
...
$OutFile      = "$env:USERPROFILE\Desktop\refactorings_jant_1.10.14_after_20230724_20230820.json"
# ------------------------------------------------
...
Push-Location $RepoDir
$Start = (git rev-list -1 --after="2023-07-24 00:00" --all)
$End   = (git rev-list -1 --before="2023-08-21 00:00" --all)
Pop-Location
