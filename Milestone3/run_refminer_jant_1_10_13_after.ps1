<#
    Script: run_refminer_jant_1_10_13_after.ps1
    Purpose: Runs RefactoringMiner on JAnt repo for commits
             after version 1.10.13 — window between 11 Jan 2023 and 7 Feb 2023 (28 days).
...
$OutFile      = "$env:USERPROFILE\Desktop\refactorings_jant_1.10.13_after_20230111_20230207.json"
# ------------------------------------------------

Write-Host "=== RefactoringMiner Runner for JAnt v1.10.13 AFTER Window ===`n" -ForegroundColor Cyan
...
if (-not (Test-Path $RepoDir)) {
    ...
    git clone https://github.com/apache/jakarta-ant.git $RepoDir
} else {
...
Push-Location $RepoDir
$Start = (git rev-list -1 --after="2023-01-11 00:00" --all)
$End   = (git rev-list -1 --before="2023-02-08 00:00" --all)
Pop-Location
