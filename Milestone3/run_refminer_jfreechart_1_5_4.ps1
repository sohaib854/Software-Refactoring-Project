<#
    Script: run_refminer_jfreechart_1_5_4.ps1
    Purpose: Runs RefactoringMiner on JFreeChart repo for commits
             before version 1.5.4 — window between 11 Dec 2022 and 7 Jan 2023 (28 days).
...
$OutFile      = "$env:USERPROFILE\Desktop\refactorings_jfreechart_1.5.4_20221211_20230107.json"
# ------------------------------------------------

Write-Host "=== RefactoringMiner Runner for JFreeChart v1.5.4 Window ===`n" -ForegroundColor Cyan
...
# 4. Get commit SHAs for the date window (BEFORE window)
Push-Location $RepoDir
$Start = (git rev-list -1 --before="2022-12-11 00:00" --all)
$End   = (git rev-list -1 --before="2023-01-08 00:00" --all)
Pop-Location
