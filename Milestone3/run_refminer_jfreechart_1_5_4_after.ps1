<#
    Script: run_refminer_jfreechart_1_5_4_after.ps1
    Purpose: Runs RefactoringMiner on JFreeChart repo for commits
             after version 1.5.4 — window between 9 Jan 2023 and 5 Feb 2023 (28 days).
...
$OutFile      = "$env:USERPROFILE\Desktop\refactorings_jfreechart_1.5.4_after_20230109_20230205.json"
# ------------------------------------------------

Write-Host "=== RefactoringMiner Runner for JFreeChart v1.5.4 AFTER Window ===`n" -ForegroundColor Cyan
...
Push-Location $RepoDir
$Start = (git rev-list -1 --after="2023-01-09 00:00" --all)
$End   = (git rev-list -1 --before="2023-02-06 00:00" --all)
Pop-Location
